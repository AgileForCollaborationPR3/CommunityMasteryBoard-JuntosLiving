...
<template>
  <q-page class="bg-lpage q-px-sm">
    ...
    >
      <div v-if="loading">
        <q-card
          class="bg-accent text-primary q-pa-sm"
      ...
      <div v-if="entry">
        ...
        <div>
          <h6
            class="lora text-h6 text-primary text-weight-bold q-mb-none q-mt-md"
          >
            Comments
          </h6>
          <div
          ...
          <div v-else>
            <q-card
              ...
              class="bg-white text-primary q-pa-sm q-mb-sm"
